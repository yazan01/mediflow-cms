...
export default function PrescriptionPrintPage() {
  ...
  const [clinic, setClinic] = useState<{ clinicName: string; phone: string; address: string; licenseNumber: string } | null>(null);
  ...
  return (
    <>
      ...
      <div className="max-w-[680px] mx-auto px-4 py-6">
        {/* Header */}
        <div className="flex items-start justify-between pb-4 border-b-2 border-[#002045] mb-5">
          <div>
          ...
          <div className="text-right">
            <div className="text-xl font-bold text-[#1960a3] tracking-wide">PRESCRIPTION</div>
        ...
        <div className="grid grid-cols-2 gap-4 mb-5 p-3 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div>
            ...
            <p className="font-bold text-[#1a1c1e]">Dr. {data.doctor.name}</p>
            ...
            <div className="space-y-1">
              {data.diagnoses.map((d, i) => (
                <div key={i} className="flex items-start gap-2">
                  <span className="text-[10px] font-bold bg-[#002045] text-white px-1.5 py-0.5 rounded font-mono flex-shrink-0">{d.icdCode}</span>
        ...
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-2xl font-bold text-[#002045] italic">℞</span>
              ...
              {data.prescriptions.map((rx, i) => (
                <div key={rx.id} className="p-3 border border-gray-200 rounded-lg">
                  <div className="flex items-start justify-between">
                    <div>
                      <p className="font-bold text-[#1a1c1e]">{i + 1}. {rx.medicationName}</p>
        ...
        <div className="flex justify-between items-end mt-8 pt-4 border-t border-gray-200">
          <div>
            <p className="text-xs text-gray-400">This prescription is valid for 30 days from the date of issue.</p>
            <p className="text-xs text-gray-400 mt-0.5">Issued by {clinic?.clinicName || "MediFlow Clinic"}</p>
          </div>
