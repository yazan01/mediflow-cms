...
- **الوضع الداكن (Dark Mode)** — تبديل فوري بين الوضعين، محفوظ بين الجلسات
- **قائمة جانبية قابلة للطي** — تتقلص إلى 72px مع أيقونات فقط، موفّرة مساحة شاشة أكبر
...
| الحركات والرسوم | Framer Motion v12 |
